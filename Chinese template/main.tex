...
\centering %图片居中
\includegraphics[width=0.8\textwidth]{./Figure/example1.jpeg} %插入图片，[]中设置图片大小，{}中是图片文件名
...
\begin{figure}[H]
    ...
    \subfigure[name1]{
    \label{Fig.sub.1}
    \includegraphics[width=0.3\textwidth]{./Figure/example1.jpeg}}
    \subfigure[name2]{
    \label{Fig.sub.2}
    \includegraphics[width=0.3\textwidth]{./Figure/example2.jpeg}}
    \subfigure[name3]{
    \label{Fig.sub.3}
    \includegraphics[width=0.3\textwidth]{./Figure/example3.jpeg}}
    \caption{Main name}
    \label{Fig.main}
\end{figure}
